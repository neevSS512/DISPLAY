...
import "../styles/ludocounterm.scss";

const LudoCounterM = ({ user, handleClose }) => {
  ...
  const handleUpdate = async (updatedUser) => {
    try {
      ...
      const response = await axios.patch(`http://147.93.27.170:3001/ludocounter/ludocounterctg/${updatedUser._id}`, updatedUser);
